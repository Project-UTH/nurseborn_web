        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <h4 class="fw-bold py-3 mb-4">Danh Sách Tài Khoản Family</h4>
                    <div class="card">
                        <div class="card-body">
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Tên Trẻ</th>
                                        <th>Tuổi Trẻ</th>
                                        <th>Nhu Cầu Đặc Biệt</th>
                                        <th>Hành Động</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php if (empty($familyAccounts)): ?>
                                        <tr>
                                            <td colspan="8" class="text-center">Không có tài khoản Family nào.</td>
                                        </tr>
                                    <?php else: ?>
                                        <?php foreach ($familyAccounts as $family): ?>
                                            <tr>
                                                <td><?php echo htmlspecialchars($family['full_name']); ?></td>
                                                <td><?php echo htmlspecialchars($family['email']); ?></td>
                                                <td><?php echo htmlspecialchars($family['phone_number'] ?? 'Không có thông tin'); ?></td>
                                                <td><?php echo htmlspecialchars($family['address'] ?? 'Không có thông tin'); ?></td>
                                                <td><?php echo htmlspecialchars($family['child_name'] ?? 'Không có thông tin'); ?></td>
                                                <td><?php echo htmlspecialchars($family['child_age'] ?? 'Không có thông tin'); ?></td>
                                                <td><?php echo htmlspecialchars($family['specific_needs'] ?? 'Không có thông tin'); ?></td>
                                                <td>
                                                    <form method="POST" action="?action=admin_family_accounts" onsubmit="return confirm('Bạn có chắc chắn muốn xóa tài khoản Family này?');">
                                                        <input type="hidden" name="action_type" value="delete_family">
                                                        <input type="hidden" name="family_user_id" value="<?php echo htmlspecialchars($family['user_id']); ?>">
